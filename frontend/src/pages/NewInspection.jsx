    ...
    return (
      <div className="space-y-4">
        ...
        <div className="flex gap-3">
          ...
          <button onClick={() => navigate('/dashboard')} className="px-4 py-2.5 border border-slate-300 hover:bg-slate-50 text-sm font-medium text-slate-700 rounded-lg transition-colors">
            Back to Dashboard
          </button>
        </div>
      </div>
